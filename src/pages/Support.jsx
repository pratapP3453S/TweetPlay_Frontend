                        ...
                        <ul className="text-center flex flex-col items-center space-y-2">
                            <li className="flex items-center">
                                ...
                                <div className="h-full">
                                    ...
                                    <a
                                        href="https://mail.google.com/mail/u/0/#sent?compose=CllgCJqVwWNvtDTRmjKTHwKNmxdcnWZrQdNMfWhLzxCdJPDLbRsxdKthbJDkglnRBzgLrfLxVdV"
                                        target="_blank"
                                        className="text-blue-500 text-sm hover:text-blue-400 "
                                    >
                                        /pratapsecondacc@gmail.com
                                    </a>
                                </div>
                            </li>
                            <li className="flex items-center">
                                ...
                                <div className="h-full">
                                    ...
                                    <a
                                        href="https://github.com/pratapP3453S"
                                        target="_blank"
                                        className="text-blue-500 text-sm hover:text-blue-400 "
                                    >
                                        /www.github.com./pratapP3453S
                                    </a>
                                </div>
                            </li>
                            <li className="flex items-center">
                                ...
                                <div className="h-full">
                                    ...
                                    <a
                                        href="https://www.instagram.com/pratap.p.s.p/"
                                        target="_blank"
                                        className="text-blue-500 text-sm hover:text-blue-400 "
                                    >
                                        /www.instagram.com/pratap.p.s.p
                                    </a>
                                </div>
                            </li>
                        </ul>
